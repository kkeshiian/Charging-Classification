...
plt.title("Confusion Matrix SVM GLCM RBF")
plt.savefig("matrix/cm_svm_glcm_rbf.png")
plt.close()
...
joblib.dump(final_model, "model/model_svm_glcm_rbf.pkl")